...
const Payment = () => {
	...
	useEffect(() => {
	  const fetchUserInfoAndLoadScripts = async () => {
	    // 사용자 정보 불러오기
	  ...
	  fetchUserInfoAndLoadScripts();

	  // 클린업 함수
	  return () => {
	    const jquery = document.querySelector('script[src="https://code.jquery.com/jquery-1.12.4.min.js"]');
	    const iamport = document.querySelector('script[src="https://cdn.iamport.kr/js/iamport.payment-1.1.7.js"]');
